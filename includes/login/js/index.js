function do_login(name, pass, url, lang){
      ...
      $.get('http://'+url+'/includes/auth.php?username='+name+'&password='+pass+'',
      function(json) {
      ...
      if(json == 'ok'){
        ...
        window.location = 'http://'+name+':'+pass+'@'+url+'/admin/index.php?setlocale='+lang;
...
//   });
   ...
   $("button.rundemo").click(function(e) {
      ...
      if(json == 'ok'){
        ...
        window.location = 'https://layla:layla@demo.laylacms.com/admin/index.php?setlocale='+lang;
