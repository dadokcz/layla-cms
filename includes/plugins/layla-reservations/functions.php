...
// $tomenu = array();
$tomenu['name'] = '{{Reservations}}';
$tomenu['page'] = 'layla-reservations';
$tomenu['post_type'] = 'reservations';
$tomenu['url'] = '?page=layla-reservations&post_type=reservations';
$tomenu['icon'] = 'today';
...
$settings['layla-reservations'][0]['title'] = '{{Invoices From details}}';
$settings['layla-reservations'][0]['name'] = 'invoices-from-details';
$settings['layla-reservations'][0]['type'] = 'input-text';
$settings['layla-reservations'][0]['selected'] = get_settings('invoices-from-details');

$settings['layla-reservations'][1]['title'] = '{{Invoices start number}}';
$settings['layla-reservations'][1]['name'] = 'invoices-start-number';
$settings['layla-reservations'][1]['type'] = 'input-text';
$settings['layla-reservations'][1]['selected'] = get_settings('invoices-start-number');


$settings['layla-reservations'][2]['title'] = '{{Invoices currency}}';
$settings['layla-reservations'][2]['name'] = 'invoices-currency';
$settings['layla-reservations'][2]['type'] = 'input-select';
$settings['layla-reservations'][2]['values'] = $currencies;
$settings['layla-reservations'][2]['selected'] = get_settings('invoices-currency');
...
if(!function_exists('get_plugin_calendar')){
	function get_plugin_calendar(){
...
if(!file_exists('data/timeslots.json')){
	file_put_contents('data/timeslots.json', '');
}