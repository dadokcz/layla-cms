...
;(function ( $, window, document, undefined ) {
  ...
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='2'>" +
    ...
    "<% for(var i = 0; i < numberOfRows; i++){ %>" +
      ...
      "<% for(var j = 0; j < 7; j++){ %>" +
      "<% var d = j + i * 7; %>" +
      "<td class='<%= days[d].classes %>' attr-date='<%= days[d].attrdate %>'><div class='day-contents'><%= days[d].day %>" +
      "</div></td>" +
      "<% } %>" +
      "</tr>" +
    "<% } %>" +
  ...
  var defaults = {
    ...
    doneRendering: null,
    render: null,
   daysOfTheWeek: ['NE', 'PO', 'ÚT', 'ST', 'ČT', 'PÁ', 'SO'],
  ...
  Clndr.prototype.createDayObject = function(day, monthEvents) {
    ...
    // uniqueness of IDs.
    // extraClasses += " calendar-day-" + day.format("YYYY-MM-DD")+ "\" date=\"" + day.format("YYYY-MM-DD");
    extraClasses += " calendar-day-" + day.format("YYYY-MM-DD");

    return this.calendarDay({
      day: day.date(),
      classes: this.options.targets.day + extraClasses,
      attrdate: day.format("YYYY-MM-DD"),
      events: eventsToday,
      date: day
    });
  };
